...
function ListingDetails() {
    ...
    const mapImages = (anImage) => {
        ...
        return (
            <div className="ratio ratio-4x3">
                <img
                    src={imageUrl}
                    className="img-fluid listing-details-cover listing-details-image:hover rounded"
                    alt="imagehere"
                />
            </div>
        );
        ...
        return (
            <Col>
                <Modal show={modal} onHide={toggleModal} size="lg">
                    ...
                    <Modal.Body>
                        <Carousel data-slide="prev next">{listingData.imageComponentsCarousel}</Carousel>
                    </Modal.Body>
            ...
            <Col>
                ...
                <Modal show={modal2} onHide={toggleModal2} size="sm">
                    <Modal.Header onHide={toggleModal2} closeButton>
                        <h4 className="modal-title listing-details-body">Amenities and Services</h4>
                    </Modal.Header>

                    <Modal.Body>
                        <div className="m-2 listing-details-body">
                            <h5>Amenities: </h5>
    ...
    const displayImages = () => {
        if (listingData.imageComponents.length === 1) {
            return (
                <div className="row">
                    <div className="col">
        ...
        if ([2, 3, 4].indexOf(listingData.imageComponents.length) > 0) {
            return (
                <div className="row">
                    <div className="col">
                        <Link onClick={toggleModal}>{listingData.imageComponents[0]}</Link>
        ...
        if (listingData.imageComponents.length >= 5) {
            return (
                <div className="row">
                    <div className="col">
                        <Link onClick={toggleModal}>{listingData.imageComponents[0]}</Link>
    ...
    if (listingData !== null) {
        return (
            <div className="container listing-details-body">
                ...
                {displayImages()}
                <Row>
                    <div className="listing-details-col-sm-60p mt-3">
                        <div className="row">
                            <Col>
                    ...
                    <div className="col mt-3">
                        <Card>
                            ...
                            <img
                                ...
                                className="img-fluid listing-details-image-center rounded"
                                alt="imagehere"
                            />
                        </Card>
                    </div>
